...
import { macBuild, windowsBuild, linuxBuild } from "./ci_env";
...
- MacOs - [Download Here]({ macBuild }) (coming soon)
- Windows x64 - [Download Here]({ linuxBuild }) (coming soon)
- Linux x64 - [Download Here]({ windowsBuild }) (coming soon)
